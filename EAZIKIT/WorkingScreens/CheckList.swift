...
//        place_tray_1
    ...
    @IBAction func startBtn(_ sender: Any)
    {
        ...
        else
        {
            ...
            let vc = storyboard.instantiateViewController(withIdentifier: "SessionScreen") as! SessionScreen
            navigationController?.present(vc, animated: true, completion: nil)
//            self.performSegue(withIdentifier: "sessionScreenScreens", sender: nil)
        }
    }
...
//     {
//
//        if segue.identifier == "sessionScreen"
//        {
//            let vc = segue.destination as! SessionScreen
//
//                let minute = firstSession.prefix(2)
//                vc.sessionTime = "\(minute)"
//        }
//
//
//
...
//    }
    ...
    func getPref()
    {
        if Reach.isConnectedToNetwork()
        {
            ...
            let baseurl = URL(string:"http://5c5d23ff.ngrok.io/preference?userId=\(id)")!//BASE_URL+"preference?userId=28")!
            ...
            Alamofire.request(baseurl, method: .get, parameters: parameters, encoding: URLEncoding.default).responseJSON{ (responseData) -> Void in
                if((responseData.result.value) != nil)
                {
                    ...
                    self.firstSession = "\(ab["Result"]["firstTime"])"
    ...
    @IBAction func backBtn(_ sender: Any)
    {
        ...
        let actionSheetController = UIAlertController(title: nil, message: "Are you sure to quit?", preferredStyle: .actionSheet)
